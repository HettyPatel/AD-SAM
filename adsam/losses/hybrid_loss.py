...
class HybridLoss(nn.Module):
    def __init__(self, num_classes=19, ignore_index=19):
        super().__init__()
        self.focal = FocalLoss(ignore_index=ignore_index, num_classes=num_classes)
        self.dice = DiceLoss(ignore_index=ignore_index, num_classes=num_classes)
        self.lovasz = LovaszSoftmax(ignore_index=ignore_index, per_image=True)
        self.boundary = SurfaceLoss(ignore_index=ignore_index)
